...
var $fontFace     = "ePatrika";
var $displayName  = "E-Patrika";
...
function EPatrika_initialize()
{
    global $fontinfo;

    $fontinfo["epatrika"]["language"] = "Devanagari";
    $fontinfo["epatrika"]["class"] = "EPatrika";
}
?>
